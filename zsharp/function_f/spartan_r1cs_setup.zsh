...
function spartan_r1cs {
    ex_name=$1
    $BIN --field-custom-modulus $modulus /Users/jiwonkim/research/tmp/Mastadon/circ-mastadon/zsharp/function_f/$ex_name.zok r1cs --action spartan-setup --prover-key IVC_P --verifier-key IVC_V
}
